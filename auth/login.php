    ...
    <div class="auth-box">
        ...
        <form action="login-process.php" method="POST">
            ...
            <select name="role" required>
                ...
                <option value="technician" <?php echo (isset($_SESSION['old_input']['role']) && $_SESSION['old_input']['role'] === 'technician') ? 'selected' : ''; ?>>Technician</option>
            </select>

            <label id="identifier-label">Email Address</label>
            <input type="text" name="identifier" id="identifier" placeholder="Enter your email" value="<?php echo isset($_SESSION['old_input']['identifier']) ? htmlspecialchars($_SESSION['old_input']['identifier']) : ''; ?>" required>
...
function syncLoginField() {
    ...
    if (role === 'technician') {
        identifierLabel.textContent = 'Email Address or Technician ID';
        identifierInput.placeholder = 'Enter your email or technician ID';
    } else {
...
roleSelect.addEventListener('change', syncLoginField);
syncLoginField();
